            ...
            verify(token, secretKeyOffice, async (err, auth_user) => {
                ...
                req.auth_user = {
                    ...
                    user: {
                        ...
                        profile_image: user.profile_image && user.profile_image.startsWith('https://') ? user.profile_image : user.profile_image ? `${req.protocol + '://' + req.get('host')}/office/profile_images/${user.profile_image}` : null,
