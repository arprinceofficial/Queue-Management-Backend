...
// Office
router.post('/office-list', authAdminMiddleware, adminController.officeList);
...
// Office Agent
router.post('/agent-user-list', authAdminMiddleware, adminController.agentUserList);
...
router.get('/queue-service/:id', authAdminMiddleware, adminController.queueServiceListById);
